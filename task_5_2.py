...
def tutor_gen(l1: list, l2: list) -> tuple:
    for i in range(len(l1)):
        yield l1[i], l2[i] if i < len(l2) else None


print(type(tutor_gen(tutors, klasses)))
for i in tutor_gen(tutors, klasses):
    print(i, end=' ')
# <class 'generator'>
# ('Иван', '9А') ('Анастасия', '7В') ('Петр', '9Б') ('Сергей', '9В') ('Дмитрий', '8Б') ('Борис', '10А') ('Елена', None)
